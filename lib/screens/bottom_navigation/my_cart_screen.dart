...
class _MyCartScreenState extends State<MyCartScreen> {
  ...
  double totalPrice = 0,
      subTotal = 0,
      tempTotalWithoutDeliveryCharge = 0;
  int? restId;
  ...
  num? vendorDiscountMinItemAmount,
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: _listPromoCode
                                                      ...
                                                      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                                                        crossAxisCount: 2,
                                                        mainAxisExtent: ScreenUtil().screenWidth / 1.8,
                                                      ),
                                                      padding: EdgeInsets.all(10),
                                                      itemCount: _listPromoCode.length,
                                                      itemBuilder: (context, index) => InkWell(
                                                        onTap: () {
                                                          ...
                                                          final DateFormat formatter = DateFormat(
                                                              'y-MM-dd');
                                                          final String orderDate = formatter
                                                              .format(
                                                              now);
                                                          isSetStateAvailable =
                                                          true;
                                                                ...
                                                                Padding(
                                                                  ...
                                                                  child: Text(
                                                                    '${Languages
                                                                        .of(
                                                                        context)!
                                                                        .labelValidUpTo} ${_listPromoCode[index]
                                                                        .startEndDate!
                                                                        .substring(
                                                                        _listPromoCode[index]
                                                                            .startEndDate!
  ...
  void openFoodCustomizationBottomSheet(CartModel cartModel,
        ...
        for (int k = 0; k < _listFinalCustomization[i].list.length; k++) {
          for (int z = 0; z < previousItemName.length; z++) {
            if (_listFinalCustomization[i].list[k].name ==
              ...
              _listForAPI.add(
                  '{"main_menu":"${_listFinalCustomization[i]
                      .title}","data":{"name":"${_listFinalCustomization[i]
                      .list[k].name}","price":"${_listFinalCustomization[i]
                      .list[k].price}"}}');
            } else {
                                                ...
                                                i]
                                                  ...
                                                  _listForAPI.add(
                                                      '{"main_menu":"${_listFinalCustomization[i]
                                                          .title}","data":{"name":"${_listFinalCustomization[i]
                                                          .list[j]
                                                          .name}","price":"${_listFinalCustomization[i]
                                                          .list[j].price}"}}');
                                                }
                                              }
                                            }
  ...
  void _updateForCustomizedFood(int? proId,
      int proQty,
      double proPrice,
  ...
  Future<BaseModel<String>> callApplyPromoCall(BuildContext context,
...
class PreviousCustomizationItemModel {
  ...
  PreviousCustomizationItemModel(this.name,
      this.datamodel,);
