...
class _OrderDetailsScreenState extends State<OrderDetailsScreen> {
  ...
  double subTotal = 0.0, couponPrice = 0.0, grandTotalAmount = 0.0, taxAmount = 0.0;
  int? promocodeId;
  ...
  Future<BaseModel<SingleOrderDetailsModel>> callGetSingleOrderDetails(int? orderId) async {
    ...
    try{
      ...
      setState(() {
        ...
        if (response.data!.vendorDiscountPrice != null && response.data!.vendorDiscountPrice != 0) {
        ...
        if (response.data!.vendor!.tax != null &&response.data!.vendor!.tax != null ) {
          if (subTotal != 0) {
